    ...
    async def madqtt_runner(self):
        while True:
            ...
            async with self._client as client:
                await self._client.publish(self._config['devices']['ATV06']['topic-pub'], payload=self._config['device.ATV06']['payload-off'])
                await asyncio.sleep(1)
                await self._client.publish(self._config['devices']['ATV06']['topic-pub'], payload=self._config['device.ATV06']['payload-on'])
